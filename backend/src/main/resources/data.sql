...
INSERT INTO FUNCTIONS (name, description, img_url, option_id, is_my_trim, function_category_id, wheel_logo_img_url) VALUES ('다크 크롬 라디에이터 그릴', null, 'https://a5idle.s3.ap-northeast-2.amazonaws.com/mycarimages/41.jpg', null, 'FALSE', 4, null);
INSERT INTO FUNCTIONS (name, description, img_url, option_id, is_my_trim, function_category_id, wheel_logo_img_url) VALUES ('메탈페인트 스키드 플레이트', null, 'https://a5idle.s3.ap-northeast-2.amazonaws.com/mycarimages/56.jpg', null, 'FALSE', 4, null);
